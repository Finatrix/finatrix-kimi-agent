  ...
  return (
    <div className="fx-page">
      ...
      <div className="lib-toolbar">
        <input className="fi" style={{ maxWidth: 320 }} placeholder="Search your network…" value={search} onChange={(e) => setSearch(e.target.value)} />
        ...
        <div className="fx-modal-wrap" role="dialog" aria-modal="true" aria-label="Add contact">
          ...
          <div className="fx-modal">
            ...
            <div className="grid2" style={{ marginTop: 12 }}>
              ...
              <select className="fs" value={form.relationship} onChange={(e) => setForm((f) => ({ ...f, relationship: e.target.value as NetworkRelationship }))}>
              ...
              <input className="fi" placeholder="University" value={form.university} onChange={(e) => setForm((f) => ({ ...f, university: e.target.value }))} />
              <input className="fi" placeholder="Event" value={form.event_name} onChange={(e) => setForm((f) => ({ ...f, event_name: e.target.value }))} />
              ...
              <input className="fi" type="datetime-local" value={form.follow_up_at} onChange={(e) => setForm((f) => ({ ...f, follow_up_at: e.target.value }))} />
            </div>
      ...
      {detail && (
        <div className="fx-modal-wrap" role="dialog" aria-modal="true" aria-label={`Contact — ${detail.name}`}>
          ...
          <div className="fx-modal wide">
            ...
            <textarea className="fi" style={{ minHeight: 60, marginTop: 8 }} placeholder="What did you discuss?" value={logBody} onChange={(e) => setLogBody(e.target.value)} />
