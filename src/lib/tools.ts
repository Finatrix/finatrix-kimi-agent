export interface Tool {
  ...
  blurb: string;
  /** Route into the tool (native React page). */
  href: string;
...
export const TOOLS: Tool[] = [
  ...
  { id: 'peercompare', name: 'PeerCompare', short: 'Compare', blurb: 'Measure your money against national benchmarks.', href: '/tools/peercompare', color: '#7C5CFF', icon: 'compare' },
